...
export const Signup = createAsyncThunk(
    ...
    async (SignupData, thunkAPI) => {
        try {
            const response = await axios.post('https://yibeebackend.vercel.app/signup', SignupData, {
                headers: {
...
export const LoginRqst = createAsyncThunk(
    ...
    async (LoginData, thunkAPI) => {
        try {
            const response = await axios.post('https://yibeebackend.vercel.app/login', LoginData, {
                headers: {
                    'Content-Type': 'application/json',
...
export const { signup, log } = AuthSlice.actions
