        ...
        <nav className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 text-white">
            ...
            <div className="hidden md:flex lg:flex items-center justify-center gap-4 ">
              <Link className=" px-2 bg-white/15 hover:bg-white hover:text-black transition-all duration-300 rounded-xl" to="/"><ul>Home</ul></Link>
              <Link className=" px-2 bg-white/15 hover:bg-white hover:text-black transition-all duration-300 rounded-xl" to="/Explore"><ul>Explore</ul></Link>
              <Link className=" px-2 bg-white/15 hover:bg-white hover:text-black transition-all duration-300 rounded-xl" to="/Post"><ul>Post</ul></Link>
              <Link className=" px-2 bg-white/15 hover:bg-white hover:text-black transition-all duration-300 rounded-xl" to="/Account"><ul>Account</ul></Link>
            </div>
